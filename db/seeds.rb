...
answer101 = Answer.create!(question_id: question30.id, author_id: user14.id, body: 'There really is no such thing as a new design, I wouldn’t waste my time trying to protect anything. I would spend more time trying to create than protect. As you spend time stretching yourself, and your abilities, that’s where you’ll find fulfillment. People will begin searching you out because you are leaving what you have built on the table for others to copy, while blazing a path with new and fresh work to be emulated.')
