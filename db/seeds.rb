...
user1.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/padme.jpg'))
user1.save!
...
user2.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/jango.jpg'))
user2.save!
...
user3.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/jabba.jpg'))
user3.save!
...
user4.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/quigon.png'))
user4.save!
...
user5.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/obione.jpg'))
user5.save!
...
user6.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/leia.jpg'))
user6.save!
...
user7.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/anakin.jpg'))
user7.save!
...
user8.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/hansolo.png'))
user8.save!
...
user9.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/indiana_jones.jpg'))
user9.save!
...
user10.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/forrest_gump.jpg'))
user10.save!
...
user11.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/choobaka.jpg'))
user11.save!
...
user12.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/william_wallas.jpg'))
user12.save!
...
user13.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/ace_ventura.jpg'))
user13.save!
...
user14.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/jack_sparrow.jpg'))
user14.save!
user15 = User.create!(first_name: 'Tony', last_name: 'Montana', email: 'montana@questions.com', description: 'Drug Lord', password: '12345')
user15.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/tonny_montana.jpeg'))
user15.save!
...
user16.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/rocky.jpeg'))
user16.save!
...
user17.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/lebowsky.jpg'))
user17.save!
...
user18.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/fredy_kruger.jpg'))
user18.save!
...
user19.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/mcclain.jpg'))
user19.save!
...
user20.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/james_bond.jpg'))
user20.save!
user21 = User.create!(first_name: 'Vito', last_name: 'Corleone', email: 'vito@questions.com', description: 'The Godfather', password: '12345')
user21.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/corleone.jpg'))
user21.save!
user22 = User.create!(first_name: 'Ethan', last_name: 'Hunt', email: 'hunt@questions.com', description: 'IMF Agent', password: '12345')
user22.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/hunt.jpeg'))
user22.save!
...
user24.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/frank_drebin.jpg'))
user24.save!
...
user25.userpic = File.open(File.join(Rails.root, 'app/assets/images/userpics/potter.jpeg'))
user25.save!
